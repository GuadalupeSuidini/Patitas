...
from .views import buscarAmigos, contacto, datos_mascota, eliminardatos, fichaUsuario, ing_usuarios, inicio, ingreso_usuarios, lista_mascotas, registro, lista_usuario, editarusuario
...
############################################################
     ...
     path('buscarAmigos', buscarAmigos, name='buscarAmigos'),
